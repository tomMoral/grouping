...
\paragraph{Regroupement support harmonique (HGS)}\label{par:HGS}
    L'un des problème de la métrique (HG) est son manque de robustesse au bruit. En effet, 
...
\label{sub:met}
    ...
    $$La métrique d'évaluation du regroupement est alors calculer  en moyennant les valeurs minimales de $R^2$ pour chaque composante $c_i$ du signal d'origine et pour 
    $$
